...
<html lang="en">
    <head>
    <title>Joanna Gromadzka's Two examples of web cams </title>
...
<div class="wrapper">
    <header>
      <h1><a href="index.php"><i class="logo fa fa-fw fa-eye"></i>Joanna Gromadzka: Web Dev Examples</a></h1>
      <nav id="cssmenu">
          <ul>
    ...
    <!-- START LEFT COL -->
    <section>
     <h2 class="pageID">Sky News-Live</h2>
        <div class="embed-container">

           <iframe src='https://www.youtube.com/embed/XOacA3RYrXk' allowfullscreen></iframe>
        </div>
    </section>
    <!-- END LEFT COL -->
