...
<html lang="en">
    <head>
    <title>Joanna Gromadzka's YouTube Video</title>
...
<div class="wrapper">
    <header>
      <h1><a href="index.php"><i class="logo fa fa-fw fa-youtube-square"></i>Joanna Gromadzka: Web Dev Examples</a></h1>
      <nav id="cssmenu">
          <ul>
    ...
    <!-- START LEFT COL -->
    <section>
         <h2 class="pageID">Search Engine Optymization</h2>
         <div class='embed-container'>
             <iframe src='https://www.youtube.com/embed/hF515-0Tduk' allowfullscreen></iframe>
         </div>
    </section>
    <!-- END LEFT COL -->
    ...
    <aside>
      <h3>Additional Resources</h3>
          <ul>
          <li><a href="https://blog.monitorbacklinks.com/seo/search-engine-optimization-tips/" target="_blank">www.monitorbacklinks.com</a> 34 tips</li>
          <li><a href="https://searchengineland.com/10-fundamental-tips-to-improve-your-seo-14024" target="_blank">www.searchengineland.com</a> 10 fundamental rules</li>
          <li><a href="https://www.lynda.com/WordPress-tutorials/Fundamentals-SEO/557999/589454-4.html" target="_blank">www.lynda.com</a> SEO fundamentals</li>
          </ul>
    </aside>
    <!-- END RIGHT COL -->
