...
$toName = "Joanna"; //place your client's name here
$website = "Joanna Codes Big";  //place NAME of your client's website here
#--------------END CONFIG AREA ------------------------#
...
?>
	...
	<div>	
		...
		<div>	
		<fieldset>
			<legend>Do you have a server for hosting your website?</legend>
			<input type="radio" name="server?" value="Yes"/> Yes <br />
			<input type="radio" name="server?" value="No" /> No <br />
            <input type="radio" name="server?" value="I don't know" /> I don't know <br />
		</fieldset>
	   </div>
        
        <div>	
		<fieldset>
			<legend>Do you have a domain name for your website?</legend>
			<input type="radio" name="domain?" value="Yes"/> Yes <br />
			<input type="radio" name="domain?" value="No" /> No <br />
            <input type="radio" name="domain?" value="I don't know" /> I don't know <br />
		</fieldset>
	   </div>
		...
		<fieldset>
			...
			<input type="radio" name="logo?" value="Yes"/> Yes <br />
			<input type="radio" name="logo?" value="No" /> No <br />
		</fieldset>
        </div>
        
        <div>	
		<fieldset>
			<legend>Will you need  placement on web service(Search Engine Optymization- SEO)?</legend>
			<input type="radio" name="SEO?" value="Yes"/> Yes <br />
			<input type="radio" name="SEO?" value="No" /> No <br />
            <input type="radio" name="SEO?" value="I don't know" /> I don't know <br />
		</fieldset>
	   </div>
	   <div>	
		<label>
